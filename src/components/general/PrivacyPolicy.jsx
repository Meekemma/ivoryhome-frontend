...
const PrivacyPolicy = () => {
    return (
        <div className="container mx-auto px-4 py-8 bg-white text-gray-800 p-6 md:p-12 lg:p-16">
            ...
            <p>We retain your personal information only as long as necessary to provide our services and for legitimate business purposes, such as complying with legal obligations, resolving disputes, and enforcing agreements.</p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900">8. Data Transfers</h2>
            <p>Your personal information may be transferred to and maintained on servers located outside of your state, province, country, or other governmental jurisdiction where the data protection laws may differ from those in your jurisdiction. By using our services, you consent to such transfers.</p>

            <hr className="border-gray-300 my-4" />

            <h2 className="text-2xl font-semibold text-gray-900">9. Children's Privacy</h2>
            <p>Our services are not directed at individuals under the age of 13. We do not knowingly collect personal information from children under 13. If you believe that a child has provided us with personal information, please contact us, and we will take steps to delete such information.</p>
