...
const services = [
  {
    ...
    icon: <FaHome className="w-16 h-16 text-[#005fa3]" />, 
  },
  {
    ...
    icon: <FaTools className="w-16 h-16 text-[#005fa3]" />, 
  },
  {
    ...
    icon: <FaChartLine className="w-16 h-16 text-[#005fa3]" />, 
  },
];
...
const OurServices = () => {
  ...
  return (
    <section className="container mx-auto py-6 px-6 bg-[#FFF5EE]">
      {/* Meta Tags for SEO */}
      <Helmet>
