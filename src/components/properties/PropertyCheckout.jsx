    ...
    <div className="bg-gray-100 min-h-screen pb-40">
      ...
      <div className="container mx-auto mt-10 px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-md px-6 lg:px-20 rounded-lg self-start">
          ...
          <button
            className="w-full py-3 mt-4 flex items-center justify-center space-x-2 btn bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200"
            onClick={handleClick}
          >
            <FiCheck className="w-5 h-5" /> {/* Add the icon */}
            <span>Confirm</span>
          </button>
